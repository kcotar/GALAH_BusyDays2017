pro marcs_abund, abund,  elem, atwe, fehmod=fehmod, eonh12=eonh12, alpha=alpha

;Return marcs standard model abundances used in SME's 2012 marcs grid 
;
;Input:
; None
;
...
; 2012-08-18 Lind  Added input feh to specify level of alpha
;enhancement in composition
...
;       "H",  "He",  "Li",  "Be",   "B",   "C",   "N",   "O",   "F",  "Ne",
  s1=[12.00, 10.93,  1.05,  1.38,  2.70,  8.39,  7.78,  8.66,  4.56,  7.84, $
...
;      "Sb",  "Te",   "I",  "Xe",  "Cs",  "Ba",  "La",  "Ce",  "Pr",  "Nd",
  s2=[ 1.00,  2.19,  1.51,  2.24,  1.07,  2.17,  1.13,  1.70,  0.58,  1.45, $
...
;Add standard alpha-enhancement 
  i=[8,10,12,14,16,18,20,22]-1
  if keyword_set(fehmod) then begin
     if not keyword_set(alpha) then alpha=interpol([0.4,0.4,0.0,0.0],[-10.,-1.,0.0,10.0],fehmod)
     print,'Alpha-enhancement by ',alpha
     log_eonh(i) = log_eonh(i)+alpha
  endif
